...
def detect_variable_types(df):
    ...
    for col in df.columns:
        ...
        # ❌ exclude system / unwanted variables
        if col_l.startswith(("sys_", "page", "time", "duration")):
            continue
...
if uploaded_file:
    try:
        ...
        st.session_state.var_sq = st.session_state.var_types["sq"]    
